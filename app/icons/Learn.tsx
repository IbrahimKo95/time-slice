...
export default function Learn(props: { size?: number }) {
    return (
        <svg width={props.size} height={props.size} viewBox="0 0 430 430" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M191 404.631V361H139V404.631C139 406.978 141.573 408.416 143.572 407.186L165 394L186.428 407.186C188.427 408.416 191 406.978 191 404.631Z"
                fill="#F24C00"/>
            <g opacity="0.5">
                <path d="M139 361V404.631C139 406.978 141.573 408.416 143.572 407.186L165 394V361H139Z" fill="#F24C00"/>
            </g>
            <path
                d="M93 58.6665V332.438C93 340.389 96.2433 347.504 101.37 352.63C106.601 357.861 113.715 361 121.666 361H334.459C336.116 361 337.459 359.657 337.459 358V58.6665"
                fill="#4BB3FD"/>
            <g opacity="0.5">
                <path
                    d="M93 332.438V58.6665H113V332.438C113 340.389 116.243 347.504 121.37 352.63C126.601 357.861 133.715 361 141.666 361H121.666C113.715 361 106.601 357.861 101.37 352.63C96.2433 347.504 93 340.389 93 332.438Z"
                    fill="#4BB3FD"/>
            </g>
            <path
                d="M121.666 87.3329H337.459V33C337.459 31.3431 336.116 30 334.459 30H121.666C105.869 30 93 42.8685 93 58.6665C93 74.4644 105.869 87.3329 121.666 87.3329Z"
                fill="#EBE6EF"/>
            <g opacity="0.5">
                <path
